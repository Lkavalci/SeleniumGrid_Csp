...
public class DriverManager {
    ...
    public WebDriver setUpChromeDriver(){
        ...
        try {
            driver = new RemoteWebDriver(new URL("http://"),chromeOptions);   // veya "localhost:4444" yazilabilir
    ...
    public WebDriver setUpEdgeDriver(){
        ...
        try {
            driver = new RemoteWebDriver(new URL("http://"),edgeOptions); // veya "localhost:4444" yazilabilir
        } catch (MalformedURLException e) {
            throw new RuntimeException(e);
        }
...
​
    public WebDriver setUpFirefoxDriver(){
        ...
        capabilities.setVersion("114.0.2");
